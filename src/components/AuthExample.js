  ...
  const handleRegister = () => {
    ...
    auth.createUserWithEmailAndPassword(email, password)
      .then(userCredential => {
        ...
        navigate('/create-room');  // Redireciona para a criação de sala após o registro
      })
      .catch(error => {
  ...
  const handleLogin = () => {
    ...
    auth.signInWithEmailAndPassword(email, password)
      .then(userCredential => {
        ...
        navigate('/create-room');  // Redireciona para a criação de sala após o login
      })
      .catch(error => {
        // Captura erros de senha ou e-mail incorretos
