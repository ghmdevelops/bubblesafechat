...
const Login = () => {
    ...
    return (
        <div className="auth-container">
            ...
            <img onClick={() => navigate('/')} style={{ cursor: 'pointer', width: "300px" }} src={logo} alt="OpenSecurityRoom" />
            <h1>Login</h1>
            ...
            <form onSubmit={handleLogin}>
                ...
                <div className="d-flex justify-content-center gap-2 mt-2 div-btn-log">
                    ...
                    >
                        {isLoading ? 'Carregando...' : (
                            <>
                                <img src={""} alt="GitHub" style={{ width: '30px', marginRight: '5px' }} />
                                GitHub
                            </>
                        )}
                    </button>
                    ...
                    >
                        {isLoading ? 'Carregando...' : (
                            <>
                                <img src={""} alt="Facebook" style={{ width: '20px', marginRight: '5px' }} />
                                Facebook
                            </>
                        )}
                    </button>
